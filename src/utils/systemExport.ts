...
${state.deliveryZones.length > 0 ? state.deliveryZones.map((zone: any) => `- ${zone.name}: $${zone.cost} CUP`).join('\n') : '- No hay zonas configuradas'}

### Novelas Administradas
${state.novels.length > 0 ? state.novels.map((novel: any) => `- ${novel.titulo} (${novel.año}) - ${novel.capitulos} capítulos`).join('\n') : '- No hay novelas administradas'}
...
// Función para obtener el código fuente completo de AdminContext.tsx
...
// Función para obtener el código fuente completo de CartContext.tsx
...
// Función para obtener el código fuente completo de CheckoutModal.tsx
...
// Función para obtener el código fuente completo de PriceCard.tsx
...
// Función para obtener el código fuente completo de NovelasModal.tsx
...
// Funciones adicionales para obtener otros archivos fuente
...
export function getAppSource(): string {
  return \`import React from 'react';
