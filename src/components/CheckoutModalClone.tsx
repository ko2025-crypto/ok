...
// Zonas de entrega base con opción por defecto
...
export function CheckoutModalClone({ isOpen, onClose, onCheckout, items, total }: CheckoutModalProps) {
  ...
  // Obtener zonas de entrega del admin context con actualizaciones en tiempo real
  ...
  // Combinar zonas admin con zonas base - sincronización en tiempo real
  const allZones = { ...BASE_DELIVERY_ZONES_CLONE, ...adminZonesMap };
  ...
  const generateOrderText = () => {
    ...
    let orderText = `🎬 *PEDIDO - TV A LA CARTA (CLON)*\n\n`;
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-4 sm:p-6 text-white">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <div>
                <h2 className="text-xl sm:text-2xl font-bold">Finalizar Pedido (Clon)</h2>
          ...
          <div className="p-4 sm:p-6">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-4 sm:p-6 mb-6 border border-blue-200">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-gray-900">Resumen del Pedido (Clon)</h3>
              </div>
                ...
                <div className="bg-white rounded-2xl p-4 sm:p-6 border border-gray-200 shadow-sm">
                  ...
                  <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-4 mb-4 border border-green-200">
                    <div className="flex items-center mb-2">
                      ...
                      <h4 className="font-semibold text-green-900">Información de Entrega (Clon)</h4>
                    </div>
